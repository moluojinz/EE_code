...
extern int8_t mv_Cx_2, mv_Cy_2, mv_Cw_2, mv_Ch_2;   //Cx:左右偏差 左- 右+   Cy:摄像头到物体distance
extern int16_t error_angle_mv2,distance_target_mv2;
extern uint8_t stop_flag_mv2;
